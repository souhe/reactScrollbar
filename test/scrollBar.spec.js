...
describe('ScrollBar component', () => {
    ...
    it('Scrollbar should have proper container class', () => {
        let {wrapper} = setupScrollbar({containerClassName: 'test-class'});

        expect(wrapper.props.className).toInclude('test-class');
    });

    it('Scrollbar should have proper element class', () => {
        let {content} = setupScrollbar({scrollbarClassName: 'test-class'});
