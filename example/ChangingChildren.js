...
import { area, content, item } from './Simple';
...
class Content extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div>
          <button onClick={this.handleScrollBottomButtonClick.bind(this)}>
            {' '}
            Scroll Bottom{' '}
          </button>
          <button onClick={this.handleScroll100ButtonClick.bind(this)}>
            {' '}
            Scroll X 100{' '}
          </button>
          <button onClick={this.handleScrollRightButtonClick.bind(this)}>
            {' '}
            Scroll Right{' '}
          </button>
          <button onClick={this.handleScrollLeftButtonClick.bind(this)}>
            {' '}
            Scroll Left{' '}
          </button>
          <button onClick={this.handleScrollY40ButtonClick.bind(this)}>
            {' '}
            Scroll Y 40{' '}
          </button>
        </div>
        ...
        <button onClick={this.handleRemoveButtonClick.bind(this)}>
          Remove 10
        </button>
        <button onClick={this.handleScrollTopButtonClick.bind(this)}>
          {' '}
          Scroll Top{' '}
        </button>
      </div>
  ...
  handleAddButtonClick() {
    this.setState(
      { itemsCount: this.state.itemsCount + 10 },
